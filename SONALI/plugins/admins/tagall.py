...
TAGMES = [ " **𝐇𝐞𝐲 𝐂𝐨𝐨𝐥 𝐀𝐧𝐠𝐞𝐥 𝐊𝐚𝐡𝐚 𝐇𝐨🤗🥱** ",
           ...
           " **𝐘𝐚𝐡𝐚 𝐀𝐚 𝐉𝐚𝐨:- [ @SYSTEM_SUPPROT_GROUP ] 𝐌𝐚𝐬𝐭𝐢 𝐊𝐚𝐫𝐞𝐧𝐠𝐞 🤭🤭** ",
           " **𝐓𝐫𝐮𝐭𝐡 𝐀𝐧𝐝 𝐃𝐚𝐫𝐞 𝐊𝐡𝐞𝐥𝐨𝐠𝐞..? 😊** ",
           " **𝐀𝐚𝐣 𝐌𝐮𝐦𝐦𝐲 𝐍𝐞 𝐃𝐚𝐭𝐚 𝐘𝐫🥺🥺** ",
           " **𝐉𝐨𝐢𝐧 𝐊𝐚𝐫 𝐋𝐨:- [ @SYSTEM_SUPPROT_GROUP ] 🤗** ",
           " **𝐆𝐚𝐥𝐢 𝐬𝐮𝐧 𝐧𝐚 𝐡𝐚𝐢 𝐃𝐨 𝐨𝐫 𝐃𝐢𝐞 𝐤𝐞 𝐩𝐚𝐬𝐬 𝐣𝐚𝐨😗😗** ",
           " **𝐓𝐮𝐦𝐡𝐚𝐫𝐞 𝐃𝐨𝐬𝐭 𝐊𝐚𝐡𝐚 𝐆𝐲𝐞🥺** ",
           " **𝐌𝐲 𝐂𝐮𝐭𝐞 𝐎𝐰𝐧𝐞𝐫 [ @lll_BADNAM_BABY_lll ]🥰** ",
...
async def cancel_spam(client, message):
    ...
    if not is_admin:
        ...
        try:
            ...
            pass
        return await message.reply("♦ 𝐒ʏsᴛᴇᴍ sᴛᴏᴘᴘᴇᴅ ᴛᴀɢɪɴɢ...♦")
